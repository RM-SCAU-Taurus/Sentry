...
void can_device_init(void)
{
    ...
    uint32_t can_ID2[] = {TIMU_PALSTANCE_ID,TIMU_9025_ID,TIMU_ANGLE_ID, CAN_TRIGGER_MOTOR1_ID,CAN_YAW_6020_MOTOR_ID,CAN_3508_R_ID,CAN_3508_L_ID,0xFFF};
...
//				 case CAN_YAW_9025_MOTOR_ID:
//        {
//						encoder_data_receive(&YAW_9025,CAN1_Rx_data);
////            status.gimbal_status[0] = 1;
//            break;
//        }
//        case CHASSIS_MSG_ID:
